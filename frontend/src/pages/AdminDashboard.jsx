                ...
                alumnosFiltrados.map((alumno) => (
                  <div key={getId(alumno)} className="bg-white border border-slate-200 p-4 sm:p-6 rounded-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4 shadow-xs">
                    ...
                    <div className="flex flex-wrap gap-2 w-full md:w-auto">
                      ...
                      <button
                        onClick={() => { setAlumnoSeleccionado(alumno); setActiveSection('rutinas'); }}
                        className="bg-slate-900 hover:bg-slate-800 text-white text-xs px-3 py-2 rounded-lg font-semibold cursor-pointer"
                      >
                        Rutina
                      </button>
                      <button
